...
void AttractMode::checkReqs()
{
  ...
  if(checkEmulatorFile("/opt/masos/configs/all/attractmode/emulators/" + config->emulator)) {
    return;
  }
...
QString AttractMode::getGameListFolder()
{
  ...
  if(QFileInfo::exists("/opt/masos/configs/all/attractmode/romlists")) {
    return QString("/opt/masos/configs/all/attractmode/romlists");
  }
...
/*
Emulator files: /opt/masos/configs/all/attractmode/emulators
Romlists: /opt/masos/configs/all/attractmode/romlists

---- Example emulator file 1 begin ----
executable /opt/masos/supplementary/runcommand/runcommand.sh
args 0 _SYS_ snes "[romfilename]"
rompath /home/pi/MasOS/roms/snes
system Super Nintendo
romext .7z;.bin;.bs;.smc;.sfc;.fig;.swc;.mgd;.zip;.7Z;.BIN;.BS;.SMC;.SFC;.FIG;.SWC;.MGD;.ZIP
artwork flyer /home/pi/MasOS/roms/snes/flyer
artwork marquee /home/pi/MasOS/roms/snes/marquee
artwork snap /home/pi/MasOS/roms/snes/snap
artwork wheel /home/pi/MasOS/roms/snes/wheel
---- End ----
...
rompath              /home/pi/MasOS/roms/amiga
romext               .adf;.adz;.dms;.ipf;.uae;.zip;.sh;.ADF;.ADZ;.DMS;.IPF;.UAE;.ZIP;.SH
system               Commodore Amiga
info_source          thegamesdb.net
artwork    boxart          /home/pi/MasOS/roms/amiga/boxart
artwork    cartart         /home/pi/MasOS/roms/amiga/cartart
artwork    snap            /home/pi/MasOS/roms/amiga/snap
artwork    wheel           /home/pi/MasOS/roms/amiga/wheel
---- End ----
